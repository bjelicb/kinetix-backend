...
let TrainingController = class TrainingController {
    ...
    async syncBatch(user, syncBatchDto) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Batch sync workout logs and check-ins from mobile app' }),
    ...
    __metadata("design:paramtypes", [Object, sync_batch_dto_1.SyncBatchDto]),
    __metadata("design:returntype", Promise)
], TrainingController.prototype, "syncBatch", null);
