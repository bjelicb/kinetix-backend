...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'SecurePass123!', description: 'User password (min 8 characters)', minLength: 8 }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: user_role_enum_1.UserRole, example: user_role_enum_1.UserRole.CLIENT, description: 'User role' }),
